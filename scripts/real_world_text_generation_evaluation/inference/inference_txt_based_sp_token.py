...
def main():
    # ===== 你可以在这里改参数 =====
    model_name = "/carrot/zhup/[main]model-final/(VR)Mix-Source/qwen2.5vl-3b-VR-en"

    # 从哪个列表文件读取图片名（此处用英文版，亦可换中文）
    image_list_txt = "test_R_en.txt"

    # 图片所在根目录（从列表文件中读出的文件名会拼到这个目录下查找）
    images_root = "/carrot/zhup/images"
    ...
    # 输出文件
    output_txt = "/carrot/zhup/[main]inference/VR/qwen25vl3b/vr-r/output_en.txt"
    # ===== 参数到此结束 =====
