...
# ================== 配置区 ==================
PRED_JSON = "/carrot/zhup/[main]inference/VR/qwen25vl7b/vr-vr/output_en_category.json"
...
def main():
    ...
    # 6) plot heatmap
    heatmap_path = os.path.join(out_dir, "heatmap_category_confusion_number.png")
