...
def main():
    # ===== 你可以在这里改参数 =====
    model_name = "/carrot/zhup/root_ginger_expert/codes/WalkVLM/Qwen2.5-VL-7B-WalkVLM"
    ...
    # 给模型的文字指令（prompt）
    prompt = (
        "<image>\nYou are a navigation assistant for a visually impaired pedestrian.\nBased on the image and the scene summary, provide one concise real-time walking instruction or warning."
    )
    # 输出文件
    output_txt = "/carrot/zhup/[main]inference/WalkVLM/Qwen2.5VL-7B/output_en.txt"
    # ===== 参数到此结束 =====
